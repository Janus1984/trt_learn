...
def wenet_encoder():
    ...
    # 载入模型
    encoder = onnx.load("/home/janus/trt2022_src/encoder.onnx")
    ...
    start_node = Unsqueeze_29.output[0]
    ...
    graph.nodes.append(newNode) #把新节点加入计算图中
    ...
    graph.cleanup().topsort()
    onnx.save(gs.export_onnx(graph), "/home/janus/trt2022_src/encoder-new.onnx")
